      ...
      <main className="container mx-auto px-4 rounded-none py-[18px]">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          <TabsList className="flex w-full flex-wrap gap-1 h-auto p-1 mx-auto justify-center">
            ...
            <TabsTrigger value="resultado"  className="text-xs px-2 py-1.5 flex-1 min-w-fit font-semibold data-[state=active]:font-display data-[state=active]:italic">📊 Resultado Final</TabsTrigger>
          </TabsList>
