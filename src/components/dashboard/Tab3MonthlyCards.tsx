...
export const Tab3MonthlyCards = ({ records, quadrimestre = "todos" }: Tab3MonthlyCardsProps) => {
          ...
          return (
            <Card key={month.mesAno} className={`border-0 shadow-md transition-all hover:shadow-lg ${styles.bg}`}>
              <CardContent className="p-3 text-center">
                ...
                <p className="text-xs text-center"><span className="text-muted-foreground font-medium">de {month.total}</span><span className={`font-medium ${styles.label}`}> | {month.percentage.toFixed(1)}%</span></p>
              </CardContent>
            </Card>);
