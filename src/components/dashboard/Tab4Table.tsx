...
interface Tab4TableProps {
  patients: Tab4Patient[];
}

export const Tab4Table = ({ patients }: Tab4TableProps) => {
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50 hover:bg-muted/50">
                ...
                >
                  <div className="flex items-center">
                    Escovação Supervisionada {getSortIcon("primeiraConsulta")}
                  </div>
                </TableHead>
                <TableHead
                  className="font-semibold cursor-pointer hover:bg-muted/70 transition-colors"
              ...
              {paginatedPatients.map((patient, index) => (
                ...
                >
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        isConsultaPendenteTab4(patient.primeiraConsulta)
                          ? "destructive"
                          : "default"
                      }
                      className={
